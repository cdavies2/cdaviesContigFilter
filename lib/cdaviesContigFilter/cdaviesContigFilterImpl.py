...
This sample module contains one small method that filters contigs.
    ...
    def run_cdaviesContigFilter(self, ctx, params):
        """
        ...
        #BEGIN run_cdaviesContigFilter

        # Print statements to stdout/stderr are captured and available as the App log
        logging.info('Starting run_cdaviesContigFilter function. Params=' + pformat(params))
        ...
        #END run_cdaviesContigFilter

        # At some point might do deeper type checking...
        if not isinstance(output, dict):
            raise ValueError('Method run_cdaviesContigFilter return value ' +
                             'output is not type dict as required.')
        # return the results
        return [output]

    def run_cdaviesContigFilter_max(self, ctx, params):
        """
        ...
        # At some point might do deeper type checking...
        if not isinstance(output, dict):
            raise ValueError('Method run_cdaviesContigFilter_max return value ' +
                             'output is not type dict as required.')
        # return the results
        return [output]
    def status(self, ctx):
